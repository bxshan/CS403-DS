public class CardNumberLevel1 {
  private int[] cardNum;

  public CardNumberLevel1(String cardNum) {
  ...
  public CardNumberLevel1(int[] cardNum) {
  ...
  public static void main(String[] args) {
    CardNumberLevel1 num = new CardNumberLevel1("4523461827752712");
